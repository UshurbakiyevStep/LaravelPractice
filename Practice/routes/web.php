    ...
    */
    ...
    Route::get('cookie/timeVisit',[CookieController::class,'taskOne']);
    Route::get('cookie/birthday',[CookieController::class,'taskTwo']);
    Route::get('cookie/counterVisit',[CookieController::class,'taskThree']);

    Route::get('responses/withHeaders',[ResponseController::class,'taskOne']);
    Route::get('responses/withHeaders1',[ResponseController::class,'taskOneAnotherVariation']);
    Route::get('responses/withHeadersAndComponent',[ResponseController::class,'taskTwo']);

    Route::get('createFlash',[SessionController::class,'createFlashMessage']);
    Route::get('getFlash',[SessionController::class,'getFlashMessage']);
    Route::get('flashForm',[SessionController::class,'flashForm']);
    Route::get('flashFormResult',[SessionController::class,'resultForm']);
    Route::get('flashFormOld',[SessionController::class,'flashFormWithOLD']);
